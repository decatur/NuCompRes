...
%query = 'S=9&E=10&T=1&r=0.06&sigma=0.3';
%in = decode_x_www_form_urlencoded(query);
%american_option_price(in.S, in.E, in.T, in.r, in.sigma)
...
% Optionally export raw functionality of resource for unit testing.
